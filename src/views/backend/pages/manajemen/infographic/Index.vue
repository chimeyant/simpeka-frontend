      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Manajemen Infografis
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/manajement/infographic",
      pagination: false,
      key: "id",
      title: "MANAJEMEN INFOGRAFIS",
      subtitle: "Berikut Daftar Seluruh Infografis Yang Tersedia",
      breadcrumbs: [
        {
          text: "Manajemen",
          disabled: true,
