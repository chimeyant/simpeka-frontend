      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Manajemen Visualisasi
          </v-toolbar>
          <v-card-text class="mt-2">
            ...
            <v-col cols="12">
              <v-text-field
                label="Gambar Visualisasi  (Max: 2 MB)"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/manajement/visualization",
      pagination: false,
      key: "id",
      title: "MANAJEMEN VISUALISASI",
      subtitle: "Berikut Daftar Seluruh Visualisasi Yang Tersedia",
      breadcrumbs: [
        {
          text: "Manajemen",
          disabled: true,
  ...
  methods: {
    ...
    editRecord: function (val) {
      this.postEdit(val).then(() => {
        this.filename = this.record.thumbnail;
      });
      this.setForm({
        add: true,
        edit: true,
      ...
      this.assignFileBrowse({
        ...
        callback: (response) => {
          setTimeout(() => {
            ...
            this.record.thumbnail = response.name;
          }, 500);
        },
      });
    },
