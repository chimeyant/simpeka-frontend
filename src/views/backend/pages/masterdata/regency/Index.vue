      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Kab/Kota
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/master-data/regency",
      pagination: false,
      key: "id",
      title: "MASTER DATA KAB/KOTA",
      subtitle: "Berikut Daftar Seluruh Kab/Kota Yang Tersedia",
      breadcrumbs: [
        {
          text: "Master Data",
          disabled: true,
  ...
  methods: {
    ...
    editRecord: function (val) {
      this.postEdit(val).then(() => {
        this.filename = this.record.logo;
      });
      this.setForm({
        add: true,
        edit: true,
