      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Master OPD/Instansi
          </v-toolbar>
          <v-card-text class="mt-2">
            <v-col col="12">
              <v-text-field
                ...
                placeholder="Dinas Komunikasi, Informatika, Persandian dan Statistik"
                v-model="record.name"
                :filled="record.name"
                dense
              ></v-text-field>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/master-data/organization",
      pagination: false,
      key: "id",
      title: "MASTER PRODUSEN DATA",
      subtitle: "Berikut Daftar Seluruh Produsen Data Yang Tersedia",
      breadcrumbs: [
        {
          text: "Master Data",
          disabled: true,
