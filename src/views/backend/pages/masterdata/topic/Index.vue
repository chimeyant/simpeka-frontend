          ...
          <v-card-text class="mt-2">
            ...
            <v-col col="12">
              <v-text-field
                ...
                label="Urutan"
                placeholder="1 s.d ~"
                v-model="record.hierarchy"
                :filled="record.hierarchy"
                type="number"
                dense
              ></v-text-field>
            </v-col>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/master-data/topic",
      pagination: false,
      key: "id",
      title: "MASTER DATA TOPIK",
      subtitle: "Berikut Daftar Seluruh Topik Yang Tersedia",
      breadcrumbs: [
        {
          text: "Master Data",
          disabled: true,
